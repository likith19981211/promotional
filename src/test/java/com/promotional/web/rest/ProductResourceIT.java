...
import com.promotional.domain.Product;
import com.promotional.repository.ProductRepository;
import com.promotional.service.dto.ProductDTO;
import com.promotional.service.mapper.ProductMapper;
...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().productName(DEFAULT_PRODUCT_NAME);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().productName(UPDATED_PRODUCT_NAME);
        return product;
    }
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.productName(UPDATED_PRODUCT_NAME);
